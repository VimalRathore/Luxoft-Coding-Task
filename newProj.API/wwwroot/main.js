...
/* harmony import */ var _models_employeeViewModel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_models/employeeViewModel */ "./src/app/_models/employeeViewModel.ts");
...
var EmployeeComponent = /** @class */ (function () {
    function EmployeeComponent(http, empService, alertify) {
        this.http = http;
        ...
        this.model = new _models_employeeViewModel__WEBPACK_IMPORTED_MODULE_5__["EmployeeViewModel"]();
    ...
    EmployeeComponent.prototype.loadGrid = function () {
        var _this = this;
        this.empService.getAllEmployees(this.model).subscribe(function (res) { _this.rowData = res.employees; _this.model.pagination = res.pagination; }, function (error) { _this.alertify.error(error); });
    };
    EmployeeComponent.prototype.onGridReady = function (params) {
        this.gridApi = params.api;
        this.gridColumnApi = params.columnApi;
    };
    EmployeeComponent.prototype.onRemoveSelected = function () {
        var _this = this;
        ...
        this.empService.deleteAllEmployees(this.model).subscribe(function (res) {
            ...
            _this.alertify.success("Employee deleted successfully");
    ...
    EmployeeComponent.prototype.onAddRow = function () {
        ...
        this.empService.saveAllEmployees(this.model).subscribe(function (res) {
            _this.rowData = res.employees;
            _this.model.pagination = res.pagination;
            _this.alertify.success("Employee Added successfully");
        }, function (error) { _this.alertify.error(error); });
    ...
    EmployeeComponent.prototype.onUpdate = function () {
        ...
        this.empService.saveAllEmployees(this.model).subscribe(function (res) {
            _this.rowData = res.employees;
            _this.model.pagination = res.pagination;
            _this.alertify.success("Employee Saved successfully");
        }, function (error) { _this.alertify.error(error); });
    };
    __decorate([
...
/***/ "./src/app/EmployeeChart/employeechart.component.css":
/*!***********************************************************!*\
  !*** ./src/app/EmployeeChart/employeechart.component.css ***!
  \***********************************************************/
/*! no static exports found */
...
/***/ "./src/app/EmployeeChart/employeechart.component.html":
/*!************************************************************!*\
  !*** ./src/app/EmployeeChart/employeechart.component.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/EmployeeChart/employeechart.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/EmployeeChart/employeechart.component.ts ***!
  \**********************************************************/
/*! exports provided: EmployeeChartComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeChartComponent", function() { return EmployeeChartComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var EmployeeChartComponent = /** @class */ (function () {
    function EmployeeChartComponent(empService) {
        this.empService = empService;
        this.existingEmployee = 0;
        this.quitEmployee = 0;
        this.ChartLabels = ['Deleted Employess', 'Current Employees'];
        this.ChartData = [0, 0];
        this.pie = 'pie';
    ...
    EmployeeChartComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.empService.getEmployeeStatisics().subscribe(function (res) {
            _this.ChartData = [res.deletedEmployeeCount, res.currentEmployeeCount];
            _this.barChartLabels = res.yearList.map(String);
            _this.barChartData[0].data = res.employeeAdded;
            _this.barChartData[1].data = res.employeeDeleted;
        }, function (error) { console.log(error); });
    };
    // event on pie chart slice hover
    EmployeeChartComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    EmployeeChartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-employeechart',
            template: __webpack_require__(/*! ./employeechart.component.html */ "./src/app/EmployeeChart/employeechart.component.html"),
            styles: [__webpack_require__(/*! ./employeechart.component.css */ "./src/app/EmployeeChart/employeechart.component.css")]
        }),
...
/***/ "./src/app/_models/employeeViewModel.ts":
/*!**********************************************!*\
  !*** ./src/app/_models/employeeViewModel.ts ***!
  \**********************************************/
/*! exports provided: Pagination, EmployeeViewModel, EmployeeDto */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Pagination", function() { return Pagination; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeViewModel", function() { return EmployeeViewModel; });
...
var EmployeeService = /** @class */ (function () {
    function EmployeeService(http) {
        this.http = http;
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + "Employee";
    }
    EmployeeService.prototype.getAllEmployees = function (model) {
        return this.http.post(this.baseUrl + '/get-employees', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
                return response;
            }
        }));
    ...
    ;
    EmployeeService.prototype.saveAllEmployees = function (model) {
        return this.http.post(this.baseUrl + '/save-employees', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
                return response;
            }
        }));
    ...
    ;
    EmployeeService.prototype.deleteAllEmployees = function (model) {
        return this.http.post(this.baseUrl + '/delete-employees', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            if (response) {
                return response;
            }
        }));
    ...
    ;
    EmployeeService.prototype.getEmployeeStatisics = function () {
        return this.http.get(this.baseUrl + '/employee-statistics').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
    ...
    ErrorInterceptor.prototype.intercept = function (req, next) {
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (error) {
            if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpErrorResponse"]) {
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(modalStateError || serverError || "It must be ServerError");
            }
        }));
    };
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\r\n<nav class=\"navbar navbar-expand-md navbar-dark bg-primary\">\r\n    <div class=\"container\">\r\n        <a class=\"navbar-brand\" [routerLink]=\"['/home']\">Grid POC</a>\r\n        <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarsExampleDefault\" aria-controls=\"navbarsExampleDefault\"\r\n            aria-expanded=\"false\" aria-label=\"Toggle navigation\">\r\n            <span class=\"navbar-toggler-icon\"></span>\r\n        </button>\r\n\r\n        <div class=\"collapse navbar-collapse\" id=\"navbarsExampleDefault\">\r\n            <ul class=\"navbar-nav mr-auto\">\r\n                <li class=\"nav-item\" routerLinkActive=\"active\">\r\n                    <a class=\"nav-link\" [routerLink]=\"['/home']\">Employee Data</a>\r\n                </li>\r\n                <li class=\"nav-item\" routerLinkActive=\"active\">\r\n                    <a class=\"nav-link\" [routerLink]=\"['/chart']\">Graphical Representation</a>\r\n                </li>\r\n            </ul>\r\n        </div>\r\n    </div>\r\n</nav>\r\n<router-outlet></router-outlet>"
...
/* harmony import */ var _services_error_interceptor__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_services/error.interceptor */ "./src/app/_services/error.interceptor.ts");
...
/* harmony import */ var _services_employee_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./_services/employee.service */ "./src/app/_services/employee.service.ts");
...
/* harmony import */ var _EmployeeChart_employeechart_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./EmployeeChart/employeechart.component */ "./src/app/EmployeeChart/employeechart.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _EmployeeChart_employeechart_component__WEBPACK_IMPORTED_MODULE_15__["EmployeeChartComponent"],
            ],
            imports: [
            ...
            providers: [
                ...
                _services_alertify_service__WEBPACK_IMPORTED_MODULE_9__["AlertifyService"],
                _services_employee_service__WEBPACK_IMPORTED_MODULE_11__["EmployeeService"]
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]
            ]
...
/* harmony import */ var _Employee_employee_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Employee/employee.component */ "./src/app/Employee/employee.component.ts");
/* harmony import */ var src_app_EmployeeChart_employeechart_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/EmployeeChart/employeechart.component */ "./src/app/EmployeeChart/employeechart.component.ts");


var appRoutes = [
    { path: 'home', component: _Employee_employee_component__WEBPACK_IMPORTED_MODULE_0__["EmployeeComponent"] },
    { path: 'chart', component: src_app_EmployeeChart_employeechart_component__WEBPACK_IMPORTED_MODULE_1__["EmployeeChartComponent"] },
